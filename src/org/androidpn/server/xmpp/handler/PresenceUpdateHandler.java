...
public class PresenceUpdateHandler {
    ...
    protected NotificationServer notificationServer;
        ...
        try {
            ...
            if (type == null) { // null == available
                ...
                if (session != null) {
                    ...
                    List<Notification> list=notificationServer.findNotificationsByUserName(session.getUsername());
                    if (list!=null&&list.size()>0) {
                    	for(Notification notification :list){
                    		...
                    		notificationServer.deleteNotification(notification);
                    	}
					}
                }
